...
recipe_type='AlphaCrystalRecipes'
...
alpha_recipes0 = alpha_recipes0[alpha_recipes0['CRYSTAL NAME'].str.contains('item|Item') == False]

cols_names = {}
for k in range(0,46):
    #cols_names[alpha_recipes0.columns[k]]=''
...
alpha_recipes_f = alpha_recipes0[['CRYSTAL NAME', 'TYPE', 'COLOR', 'RARITY', 'TIER ', 'ABILITY',
       'FAVORED STAT 1', 'FAVORED STAT 2', 'FAVORED STAT 3',
       'SEMI-FAVORED STAT 1', 'SEMI-FAVORED STAT 2', 'SEMI-FAVORED STAT 3',
       'Total Stat Gain', 'GOLD COST', 'COST', 'Amethyst', 'Emerald', 'Topaz',
       'Smoky Quartz', 'Diamond', 'Sapphire', 'Feral Shard', 'Feral Ember',
       'Chittering Shard', 'Chittering Ember', 'Sorrowful Shard',
       'Sorrowful Ember', 'Jiggly Shard', 'Jiggly Ember', 'Soaring Ember',
       'Cunning Ember', 'Cockatrice Soul', 'Beetle Soul', 'Vampyre Soul',
       'Siphoning Soul', 'Harpy Soul', 'Cannon Soul', 'Who drops this?']]

els = ['Amethyst', 'Emerald', 'Topaz',
       'Smoky Quartz', 'Diamond', 'Sapphire', 'Feral Shard', 'Feral Ember',
       'Chittering Shard', 'Chittering Ember', 'Sorrowful Shard',
       'Sorrowful Ember', 'Jiggly Shard', 'Jiggly Ember', 'Soaring Ember',
       'Cunning Ember', 'Cockatrice Soul', 'Beetle Soul', 'Vampyre Soul',
       'Siphoning Soul', 'Harpy Soul', 'Cannon Soul']
...
def crystals_t1(df, tier, els):
    df1 = df[alpha_recipes_f2['TIER ']==tier]
    fig = px.bar(
        df1, x="CRYSTAL NAME", y=els,
